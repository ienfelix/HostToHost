    ...
    try {
        ...
        else
        {
            ...
            else
            {
                ...
                fcObtenerVistaParcialOrdenBancariaDetalleLiberada(idTipoOrden, ordenBancariaDetalle);
            }
        }
...
function fcObtenerVistaParcialOrdenBancariaDetalleLiberada(idTipoOrden, ordenBancariaDetalle) {
    try {
        if (typeof idTipoOrden === "undefined" || idTipoOrden == "")
        {
