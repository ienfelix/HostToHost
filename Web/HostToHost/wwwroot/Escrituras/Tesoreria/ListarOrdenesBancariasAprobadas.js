...
function fcListarOrdenesBancariasAprobadas(accion, pagina, filas, idSociedad, idBanco, idTipoOrden) {
    try {
        ...
        felix.fcHttpClient(constante.ASYNC_TRUE, constante.HTTP_GET, constante.TESORERIA_LISTAR_ORDENES_BANCARIAS_APROBADAS_ASYNC, parametros, function (res) {
            if (res !== "")
            {
...
function fcBuscarOrdenesBancariasAprobadas() {
    try {
        ...
        felix.fcHttpClient(constante.ASYNC_TRUE, constante.HTTP_GET, constante.TESORERIA_BUSCAR_ORDENES_BANCARIAS_APROBADAS_ASYNC, parametros, function (res) {
            if (res !== "")
            {
                if (res.codigo === constante.CODIGO_OK)
                {
...
function fcListarFiltrosOrdenesBancariasAprobadas() {
    try {
        ...
        felix.fcHttpClient(constante.ASYNC_TRUE, constante.HTTP_GET, constante.TESORERIA_LISTAR_FILTROS_ORDENES_BANCARIAS_APROBADAS_ASYNC, parametros, function (res) {
            if (res !== "")
            {
                if (res.codigo === constante.CODIGO_OK)
                {
...
function fcVerOrdenBancariaAprobada(string64OrdenBancaria) {
    try {
        ...
        var url = felix.format(constante.TESORERIA_VER_ORDEN_BANCARIA_APROBADA, string64OrdenBancaria);
