    ...
    try {
        ...
        else
        {
            ...
            else
            {
                ...
                fcObtenerVistaParcialOrdenBancariaDetalleDeshecha(idTipoOrden, ordenBancariaDetalle);
            }
        }
...
function fcObtenerVistaParcialOrdenBancariaDetalleDeshecha(idTipoOrden, ordenBancariaDetalle) {
    try {
        ...
        felix.fcHttpClient(constante.ASYNC_TRUE, constante.HTTP_GET, constante.TESORERIA_OBTENER_VISTA_PARCIAL_ORDEN_BANCARIA_DETALLE_DESHECHA_ASYNC, parametros, function (res) {
            if (res !== "")
            {
                ...
                {
                    $("#dvOrdenBancariaDetalle").replaceWith(res.vistaParcialOrdenBancariaDetalleDesecha);
