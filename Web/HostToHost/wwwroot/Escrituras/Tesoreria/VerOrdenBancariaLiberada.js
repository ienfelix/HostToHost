...
function fcMostrarOrdenBancariaTransferenciaBcr(ordenBancaria, listaOrdenesBancariasDetalle) {
    try {
        ...
        for (var i = 0; i < listaOrdenesBancariasDetalle.length; i++)
        {
            ...
            tabla += "<td><div class=\"d-flex\"><i class=\"material-icons cursor\" onclick=\"fcVerOrdenBancariaDetalleLiberada('" + ordenBancaria.idTipoOrden + "', '" + string64OrdenBancaria + "', '" + string64OrdenBancariaDetalle + "');\" title=\"Ver Factura\" >search</i>";
            tabla += "</div></td>";
            tabla += "</tr>";
        }
...
function fcVerOrdenBancariaDetalleLiberada(idTipoOrden, string64OrdenBancaria, string64OrdenBancariaDetalle) {
    try {
        ...
        var url = felix.format(constante.TESORERIA_VER_ORDEN_BANCARIA_DETALLE_LIBERADA, idTipoOrden, string64OrdenBancaria, string64OrdenBancariaDetalle);
