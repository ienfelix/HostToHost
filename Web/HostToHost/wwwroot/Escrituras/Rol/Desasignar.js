...
function fcDesasignarRol() {
    try {
        ...
        else
        {
            ...
            if (!esRolAsignado)
            {
                mensaje += constante.MENSAJE_ROL_NO_ASIGNADO;
            }
        }
        ...
        felix.fcHttpClient(constante.ASYNC_TRUE, constante.HTTP_PUT, constante.ROL_DESASIGNAR_ROL_ASYNC, parametros, function (res) {
            if (res !== "")
            {
                if (res.codigo === constante.CODIGO_OK)
                {
