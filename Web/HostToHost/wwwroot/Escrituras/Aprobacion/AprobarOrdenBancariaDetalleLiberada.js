    ...
    try {
        ...
        else
        {
            ...
            else
            {
                ...
                fcObtenerVistaParcialOrdenBancariaDetallePorAprobar(idTipoOrden, ordenBancariaDetalle);
            }
        }
...
function fcObtenerVistaParcialOrdenBancariaDetallePorAprobar(idTipoOrden, ordenBancariaDetalle) {
    try {
