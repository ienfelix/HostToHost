    ...
    try {
        ...
        else
        {
            ...
            else
            {
                ...
                fcObtenerVistaParcialOrdenBancariaDetalleAprobada(idTipoOrden, ordenBancariaDetalle);
            }
        }
...
function fcObtenerVistaParcialOrdenBancariaDetalleAprobada(idTipoOrden, ordenBancariaDetalle) {
    try {
