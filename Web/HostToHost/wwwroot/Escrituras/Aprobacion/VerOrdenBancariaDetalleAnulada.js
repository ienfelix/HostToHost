    ...
    try {
        ...
        else
        {
            ...
            else
            {
                ...
                fcObtenerVistaParcialOrdenBancariaDetalleAnulada(idTipoOrden, ordenBancariaDetalle);
            }
        }
...
function fcObtenerVistaParcialOrdenBancariaDetalleAnulada(idTipoOrden, ordenBancariaDetalle) {
    try {
